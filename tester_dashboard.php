                                    ...
                                    <div class="col-auto">
                                                ...
                                                ?>
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="d-flex"><a href="tester_testdetails.php?id=<?= $data['id']; ?>" class="btn btn-sm btn-success mr-1">See Details</a><a href="tester_newtest.php?id=<?= $data['id']; ?>" class="btn btn-sm btn-secondary mr-1">New Test</a>
                                                        </tr>
                                                    </tbody>
                                                <?php
                                                endforeach;
                                        ...
                                        <nav aria-label="...">
                                            <div class="col text-center">
                                                <a href="tester_recordtest.php" class="btn btn-outline-success">See in Progress Testing</a>
                                            </div>
                                        </nav>
                                    </div>
                                </div>
