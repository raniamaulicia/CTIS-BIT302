...
class Auth extends CI_Controller
{
    ...
    public function logout()
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">
            You are logged out of CTIS
          </div>');
        redirect('auth/');
    }
    /*public function tcm_home()
    {
        $this->form_validation->set_rules('tc_name', "Test Centre's Name", 'required|trim|is_unique[test_centre.tc_name]');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/auth_header', $data);
            $this->load->view('auth/tcm_home');
            $this->load->view('templates/auth_footer');
        } else {
            echo 'Test Centre Added';
        }
    }*/
}
