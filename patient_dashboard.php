                                ...
                                <div class="justify-content-center">
                                    <div class="col-auto">
                                        <div class="table-responsive">
                                            ...
                                            $query = mysqli_query($connection, "SELECT * from testreport_table WHERE user_id = '$id'");
                                                ...
                                                ?>
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="d-flex"><a href="patient_testdetails.php?id=<?= $data['id']; ?>" class="btn btn-sm btn-secondary mr-1">See Details</a>
                                                        </tr>
                                                    </tbody>
                                                <?php
                                                endforeach;
