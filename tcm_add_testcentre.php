                            ...
                            <div class="row">
                                <div class="col-lg">
                                    <div class="p-5">
                                        ...
                                        <form class="user" method="post" action="query_testcentre.php">

                                            <div class="form-group">
                                                <input type="text" pattern="[a-zA-Z]*" class="form-control form-control-user" id="fullname" name="testcentre_name" placeholder="Test Centre's Name">
