                                ...
                                <div class="col-lg">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Add Test Kit</h1>
                                            <hr>
                                        </div>
                                        <?php include "connection.php";
                                        $query = mysqli_query($connection, "SELECT tester_id, username, tester_name, testcentre_name from tester_table"); ?>
                                        <form class="user" method="post" action="query_testkit.php">
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-user" name="testkit_name" aria-describedby="fullname" placeholder="Test Kit's Name" required>
                                            </div>
                                            <div class="form-group">
                                                <input type="number" min="1" class="form-control form-control-user" name="testkit_stock" placeholder="Stock Availibility" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="tcm_testcentre">Assigned to</label>
