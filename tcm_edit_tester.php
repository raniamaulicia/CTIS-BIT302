...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = mysqli_query($connection, "SELECT * FROM user_table WHERE id= $id");
    $row = mysqli_fetch_assoc($query);
}

if (isset($_GET['tester_id'])) {
    $tester_id = $_GET['tester_id'];
    $query = mysqli_query($connection, "SELECT * FROM tester_id WHERE tester_id= $tester_id");
    $row = mysqli_fetch_assoc($query);
}
                                ...
                                <div class="col-lg">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Tester Update</h1>
                                            <hr>
                                        </div>
                                        <form class="user" method="post" action="query_update_tester.php?id=<?= $id; ?>">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user" name="fullname" placeholder="Tester's Name" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
